...
outfile1 = open('dataSets/trim_data_coul.csv', 'w')
outfile2 = open('dataSets/trim_data_pccm.csv', 'w')
outfile3 = open('dataSets/trim_data_pccm24.csv', 'w')
outfile4 = open('dataSets/data_dpccm.csv', 'w')
